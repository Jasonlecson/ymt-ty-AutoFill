...
******************************************************************************/
#if 1 //1:国内  0:国外
#define PRODUCT_KEY "nzo3lzo6ebazkfwv"    //开发平台创建产品后生成的16位字符产品唯一标识
#else
#define PRODUCT_KEY "x6pawkkb3zq8q9fn"    //开发平台创建产品后生成的16位字符产品唯一标识
#endif

#define MCU_VER "1.2.1"         //用户的软件版本,用于MCU固件升级,MCU升级版本需修改
...
//补光灯(可下发可上报)
//备注:补光灯
#define DPID_FILL_LIGHT_ON 123 //灯光开关
#define DPID_FILL_COLOR 124 //灯光色温
#define DPID_FILL_TIMER 125 //定时功能
#define DPID_FILL_BRIGHT_MODE 126 //调光模式
#define DPID_FILL_BRIGHT 127 //亮度
#define DPID_FILL_HABIT 128 //喜好
