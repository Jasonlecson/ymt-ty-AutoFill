...
void factory_reset(void){
	...
	FlashSetFillLightBright(100);
	FlashSetFillLightMode(1);
	FlashSetFillLightOn(1);
	FlashSetFillLightCtrlMode(1);
	FlashSetFillLightColor(0);
	FlashSetFillLightHabit(0);
	FlashSetFillLightTimer(0);
...
void sensor_data_value_init(void){
	...
	//补光灯模式
	sensor_control_struct_value.openmode = FlashGetFillLightMode();
	sensor_control_struct_value.openmode_copy = 1- sensor_control_struct_value.openmode;
	printf("\r\n补光灯模式=%d\r\n",sensor_control_struct_value.openmode);
	//补光灯控制模式
	sensor_control_struct_value.control_mode = FlashGetFillLightCtrlMode();
	sensor_control_struct_value.control_mode_copy = 1- sensor_control_struct_value.control_mode;
	printf("\r\n补光灯模式=%d\r\n",sensor_control_struct_value.control_mode);
	//补光灯开启
	sensor_control_struct_value.fill_light_on = FlashGetFillLightOn();
	sensor_control_struct_value.fill_light_on_copy = 1- sensor_control_struct_value.fill_light_on;
	printf("\r\n补光灯模式=%d\r\n",sensor_control_struct_value.fill_light_on);
	
	sensor_control_struct_value.on = FlashGetSwitch();
	sensor_control_struct_value.on_copy = 1 - sensor_control_struct_value.on;
	
	sensor_control_struct_value.habit = FlashGetFillLightHabit();
	sensor_control_struct_value.habit_copy = 1- sensor_control_struct_value.habit;
...
//	/*******************************************补光灯*******************************************/
//	sensor_control_struct_value.fill_light_on = fill_light_get();
...
//		mcu_dp_value_update(DPID_WATER,50);//上报
	...
	/*******************************************补光灯*******************************************/
	if(sensor_control_struct_value.fill_light_on != sensor_control_struct_value.fill_light_on_copy){
		sensor_control_struct_value.fill_light_on_copy = sensor_control_struct_value.fill_light_on;
		mcu_dp_bool_update(DPID_FILL_LIGHT_ON,sensor_control_struct_value.fill_light_on);//上报
	}
	...
	//补光灯模式
	if(sensor_control_struct_value.openmode != sensor_control_struct_value.openmode_copy){
		sensor_control_struct_value.openmode_copy = sensor_control_struct_value.openmode;
		FlashSetFillLightMode(sensor_control_struct_value.openmode);
		mcu_dp_enum_update(DPID_FILL_LIGHT_MODE,sensor_control_struct_value.openmode); //上报
		printf("\r\n补光灯模式=%d\r\n",sensor_control_struct_value.openmode);
	}
	if(sensor_control_struct_value.fill_light_on != sensor_control_struct_value.fill_light_on_copy){
		sensor_control_struct_value.fill_light_on_copy = sensor_control_struct_value.fill_light_on;
//		FlashSetFillLightOn(sensor_control_struct_value.fill_light_on);
	...
	if(sensor_control_struct_value.color_selection != sensor_control_struct_value.color_selection_copy){
		sensor_control_struct_value.color_selection_copy = sensor_control_struct_value.color_selection;
		mcu_dp_enum_update(DPID_FILL_COLOR,sensor_control_struct_value.color_selection); //上报
	}
	if(sensor_control_struct_value.time_selection != sensor_control_struct_value.time_selection_copy){
		sensor_control_struct_value.time_selection_copy = sensor_control_struct_value.time_selection;
		mcu_dp_enum_update(DPID_FILL_TIMER,sensor_control_struct_value.time_selection); //上报
	}
	if(sensor_control_struct_value.control_mode != sensor_control_struct_value.control_mode_copy){
		sensor_control_struct_value.control_mode_copy = sensor_control_struct_value.control_mode;
		mcu_dp_enum_update(DPID_FILL_BRIGHT_MODE,sensor_control_struct_value.control_mode); //上报
	}
	...
	if(sensor_control_struct_value.brightness != sensor_control_struct_value.brightness_copy){
		sensor_control_struct_value.brightness_copy = sensor_control_struct_value.brightness;
//		FlashSetFillLightBright(sensor_control_struct_value.brightness);
		mcu_dp_value_update(DPID_FILL_BRIGHT,sensor_control_struct_value.brightness); //上报
	}
	if(sensor_control_struct_value.habit != sensor_control_struct_value.habit_copy){
		sensor_control_struct_value.habit_copy = sensor_control_struct_value.habit;
		mcu_dp_enum_update(DPID_FILL_HABIT,sensor_control_struct_value.habit); //上报
	}
