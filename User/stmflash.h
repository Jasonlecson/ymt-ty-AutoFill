...
#define FLASH_USE_FLASH_FILLLIGHT_BRIGHT (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+116+4) //116 117

#define FLASH_USE_FLASH_FILLLIGHT_ON (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+118+4) //118 119

#define FLASH_USE_FLASH_FILLLIGHT_CONTROL (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+120+4) //120 121

#define FLASH_USE_FLASH_FILLLIGHT_COLOR (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+122+4) //122 123

#define FLASH_USE_FLASH_FILLLIGHT_HABIT (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+124+4) //124 125

#define FLASH_USE_FLASH_FILLLIGHT_TIMER (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+126+4) //126 127

#define FLASH_USE_SWITCH (FLASH_DATA_ADDR+FLASH_DATA_ADDR_OFFSET+128+4) //128 129
